...
public class LinkedList 

	{
		...
		{
			//create new node with the data they giving
			Node new_node=new Node(data);
			
			//Theere are no element in the list 
			if(list.head==null)
			{
				list.head=new_node;
			}
			...
			{
				//Travel theough all elements till you get next as null
				Node last=list.head;
